...
**Tips:**
- Write outputs to `gs://leap-scratch/<your_username>/`, `gs://leap-persistent/`, or 's3://leap-pangeo-inbox/' as appropriate. You can find more information on how to write directly to GCS and OSN [here](https://leap-stc.github.io/data/data_tools/#usage_1)
